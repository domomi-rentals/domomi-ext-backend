    ...
    try {
      ...
      if (!application) {
        ...
        let mailOptions = {
          ...
          subject: 'Homer Rental Application',
          text: `Hi ` + application.validatedFname + `!
          
          We have your requested Rental Application from `+ renter.fname + ` attached here.
          ...
          attachment: {
            filename: 'Rental Application - ' + renter.fname + ' ' + renter.lname + '.pdf',
